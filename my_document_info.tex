...
\title{Multi-Floor Navigation with\\Hierarchical Graphs}
% \title{Navigation of mobile robots in large multi-story environments with straight and predictable paths}
% \subtitleotherlanguage{test}
% title in the other language
\titleotherlanguage{Stockwerkübergreifende Navigation mit hierarchischen Graphen}
% \subtitle{test}

\author{Andreas Zachariae B.Sc.}
\address{My Address}
\city{7613x Karlsruhe}
\email{Andreas.Zachariae@h-ka.de}

\keywords{Mobile Robotics, Multi-Floor Navigation, Path Planning, Hierarchical Graph, Straight Paths, Roadmap, ROS 2}
\keywordsotherlanguge{Mobile Robotik, Stockwerkübergreifende Navigation, Pfladplanung, Hierarchischer Graph, Gerade Pfade, ROS 2}
...
\editingtime{Student No.: 68226\\Thesis No.: 22/010\\01. January 2023}{30. June 2023}
