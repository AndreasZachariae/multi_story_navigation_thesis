...
\lstset{language=C++, mathescape=true, caption={Pseudo code of the ILIR straight path planner}, label={lst:pseudo_code_ilir}, morekeywords={from, to, is, input, output, each, in, end, do, then}}
...
\lstset{language=C++, mathescape=true, caption={Pseudo code of Hierarchical Path Planning}, label={lst:pseudo_code_ilir}, morekeywords={from, to, is, input, output, each, in, end, then}}
\begin{lstlisting}[float=h]
...
\lstset{language=C++, mathescape=true, caption={Pseudo code of recursive planning function}, label={lst:pseudo_code_recursive}, morekeywords={from, to, is, input, output, each, in, end, then, enumerator, algorithm}}
\begin{lstlisting}[float=h]
